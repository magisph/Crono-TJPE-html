...
Gerenciador do cronograma de estudos para o concurso do **TJPE**, como aplicativo web instalável (PWA), **otimizado para Android (celular e tablet)**.
...
- Design responsivo e acessível, seguindo o **Material Design 3** (alvos de toque ≥ 48dp, `prefers-reduced-motion`).
...
| `icons/`, `favicon.svg`, `favicon-32.png` | Ícones do app (Android/Chrome). |
